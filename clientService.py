...
from speech_to_text.transcriptGenerator import generateTranscript
from spellingcorrector.spellcorrector import spell_corrector
from keywordspotter.keywordSpotter import AddMultiKeywords
...
if __name__ == "__main__":
    ...
    httpd.serve_forever()
    clntApp.run(host='localhost', debug=True)